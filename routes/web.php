...
Route::group(['prefix' => 'store'], function () {
    ...
    Route::get('/{id}/delete',[\App\Http\Controllers\StoreController::class ,'destroy'])->name('stores.destroy');

//    Route::post('/search',[\App\Http\Controllers\StoreController::class,'search'])->name('stores.search');
